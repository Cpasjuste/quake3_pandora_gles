...
int	SV_NumForGentity( sharedEntity_t *ent ) {
	...
	num = ( (qbyte *)ent - (qbyte *)sv.gentities ) / sv.gentitySize;
...
sharedEntity_t *SV_GentityNum( int num ) {
	...
	ent = (sharedEntity_t *)((qbyte *)sv.gentities + sv.gentitySize*(num));
...
playerState_t *SV_GameClientNum( int num ) {
	...
	ps = (playerState_t *)((qbyte *)sv.gameClients + sv.gameClientSize*(num));
