...
/*
	...
	pglSurface = eglCreatePbufferSurface(sglDisplay, sglConfig, attrib_list_pbuff);
	...
	glRenderbufferStorage(GL_RENDERBUFFER, kDepthFormat, 800, 480);
...
/*
	if (oldContext != sglContext)
		eglMakeCurrent(sglDisplay, sglSurface, sglSurface, oldContext);
*/
...
void GLimp_InitGLES()
{
	...
	x11Window = XCreateWindow( x11Display, RootWindow(x11Display, x11Screen), 0, 0, 800, 480,
